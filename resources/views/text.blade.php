<div class="main main-raised">
    ...
    <div class="section section-navbars cd-section" id="navigation">
        ...
        <!--             navbar -->
        {{-- <div id="navbar">
            <div class="navigation-example" style="background-image: url('../../theme/img//bg.jpg');">
                ...
                <div class="container">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <a href="javascript:;" class="profile-photo dropdown-toggle nav-link" data-toggle="dropdown">
                            ...
                            <img src="../../theme/img/faces/avatar.jpg" alt="Circle Image" class="rounded-circle img-fluid">
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <h6 class="dropdown-header">Dropdown header</h6>
        ...
        <div class="container tim-container">
            ...
            {{-- <div id="images">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <h4>Rounded Image</h4>
                        <img src="../../theme/img/faces/avatar.jpg" alt="Rounded Image" class="rounded img-fluid">
                    </div>
                    ...
                    <div class="col-sm-2 ml-auto">
                        ...
                        <img src="../../theme/img/faces/avatar.jpg" alt="Raised Image" class="img-raised rounded img-fluid">
                    </div>
                    <div class="col-sm-2 ml-auto">
                        <h4>Circle Raised</h4>
                        <img src="../../theme/img/faces/avatar.jpg" alt="Thumbnail Image" class="img-raised rounded-circle img-fluid">
                    </div>
                </div>
                <div class="row">
                </div>
        ...
        <div class="row">
            ...
            <div class="card card-raised card-carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <img class="d-block w-100" src="../../theme/img/bg2.jpg" alt="First slide">
                    ...
                    <img class="d-block w-100" src=".../../theme/img/bg3.jpg" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                        <h4>
                        <i class="material-icons">location_on</i>
                    ...
                    <div class="carousel-item">
                    <img class="d-block w-100" src="../../theme/img/bg.jpg" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
                        <h4>
                        <i class="material-icons">location_on</i>
                        Yellowstone National Park, United States
    ...
    <div class="section section-signup page-header" style="background-image: url('../../theme/img/city.jpg');">
        <div class="container">
        <div class="row">
    ...
    {{-- <div class="section section-examples">
        ...
        <div class="row">
            ...
            <a href="examples/landing-page.html" target="_blank">
                <img src="../../theme/img/landing.jpg" alt="Rounded Image" class="img-raised rounded img-fluid">
                <button class="btn  btn-link btn-primary btn-lg">View Landing Page</button>
            </a>
            </div>
            <div class="col-md-6">
            <a href="examples/profile-page.html" target="_blank">
                <img src="../../theme/img/profile.jpg" alt="Rounded Image" class="img-raised rounded img-fluid">
